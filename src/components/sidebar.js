        ...
        <div>
            ...
            <Menu>
                ...
                <div style={{textAlign:"center"}}>
                    ...
                    <div><a href="https://twitter.com/ddbarochiya" target="_blank" rel="noopener noreferrer"><i className="icon-twitter2" /></a></div>
                    <div><a href="https://www.instagram.com/rohit4515/" target="_blank" rel="noopener noreferrer"><i className="icon-instagram" /></a></div>
                    <div><a href="https://www.linkedin.com/in/rohit-upadhyay-b48395135/" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></div>
