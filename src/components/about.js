                                ...
                                <div className="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                                    <div className="col-md-12">
                                        <div className="about-desc">
                                            ...
                                            <p>
                                                I am a working professional currently working with ECS Infosolutions Pvt. Ltd as a AWS Solutions Architect, currently studying for the Associate Developer. I got my graduation in Computer Science from 
